...
static ur_result_t CreateMemoryProviders(ur_platform_handle_t_ Platform) {
  ...
  UMF_RETURN_UR_ERROR(umf_result);
  ...
  for (auto &Device : Platform.Devices) {
    ...
    umf_result = umf::createMemoryProvider(
        CUMemoryProviderParams, device, context, UMF_MEMORY_TYPE_DEVICE,
    ...
    umf_result = umf::createMemoryProvider(
        CUMemoryProviderParams, device, context, UMF_MEMORY_TYPE_SHARED,
    ...
    std::call_once(
        ...
        [](ur_result_t &Result) {
          ...
          try {
            ...
            UR_CHECK_ERROR(CreateMemoryProviders(Platform));
